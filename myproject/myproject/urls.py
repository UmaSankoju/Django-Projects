...
from basic.views import base, home, about, services, contactus, sample, sample1, studentdata, productinfo, pagination, pagination1, createdata, createproduct, createEmployee
